...
final.df = new.df %>% select(Player, Yr, Tm, College, Yrs, allstar, allstar.pred)

draft2007 = final.df %>% filter(Yr == 2007) %>% arrange(desc(allstar.pred));print(draft2007)
draft2006 = final.df %>% filter(Yr == 2006) %>% arrange(desc(allstar.pred));print(draft2006)
draft2005 = final.df %>% filter(Yr == 2005) %>% arrange(desc(allstar.pred));print(draft2005)
draft2004 = final.df %>% filter(Yr == 2004) %>% arrange(desc(allstar.pred));print(draft2004)
draft2003 = final.df %>% filter(Yr == 2003) %>% arrange(desc(allstar.pred));print(draft2003)
draft2002 = final.df %>% filter(Yr == 2002) %>% arrange(desc(allstar.pred));print(draft2002)
draft2001 = final.df %>% filter(Yr == 2001) %>% arrange(desc(allstar.pred));print(draft2001)
draft2000 = final.df %>% filter(Yr == 2000) %>% arrange(desc(allstar.pred));print(draft2000)
draft1999 = final.df %>% filter(Yr == 1999) %>% arrange(desc(allstar.pred));print(draft1999)
draft1998 = final.df %>% filter(Yr == 1998) %>% arrange(desc(allstar.pred));print(draft1998)
draft1997 = final.df %>% filter(Yr == 1997) %>% arrange(desc(allstar.pred));print(draft1997)
draft1996 = final.df %>% filter(Yr == 1996) %>% arrange(desc(allstar.pred));print(draft1996)
draft1995 = final.df %>% filter(Yr == 1995) %>% arrange(desc(allstar.pred));print(draft1995)
